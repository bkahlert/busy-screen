        ...
        suspend fun poll(
            ...
            HttpClient(Js).use { client ->
                ...
                while (info == null) {
                    ...
                    try {
                        val response = client.get<HttpResponse>(endpoint).receive<String>()
